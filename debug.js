function test(){
    ...
    input = "turn on" [89,959] + "through" [759,964] + "turn off" [820,516] + "through" [871,914]
    ...
    for(var x in list){
        if (list[x] === "turn on" && list[x] === "through"){
    ...
    for(var i =0; i < instructions.length; i++){
        ...
        else if(instructions[i] === "turn off"){
            var xS = start[i][0]
            var yS = start[i][1]
